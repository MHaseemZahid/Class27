...
// create function to return first name and last name with parameter 
 function fun_fname_lname(fName,lName){//parameters 
     var output=fName+lName;
    return  output;
}

var o1 =fun_fname_lname("Muhammad ","Haseem");
console.log(o1);
